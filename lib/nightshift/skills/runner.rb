  ...
  module Skills
    ...
    module Runner
      ...
      def run(skill_name, item:, worktree_path:, context: nil, batch_index: nil, harness: nil)
        ...
        # Le harness vient du claim (slot deja budgete) ; le repli est partage
        # avec le comptage de concurrence du Reconciler.
        binary = Nightshift.claimed_harness(skill_name, harness)
