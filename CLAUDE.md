...
- **Un seul remote de push : `origin`**. Jamais de fork. Une stacked PR exige que toutes les branches de la pile vivent dans le repo de base — depuis un fork, la branche qui sert de base a la PR suivante n'existe pas cote upstream.
