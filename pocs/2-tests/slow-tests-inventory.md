...
| # | Fichier spec | Ligne(s) | Temps CI | Nb slow | Statut | Avant (local) | Après | Gain |
|---|---|---|---|---|---|---|---|---|
...
| U03 | `spec/models/dossier_spec.rb` | :2645, :1040, :1919, :1904, :1884 | 5.93s | 5 | ✅ T08 | 64.03s | 54.79s | -14.4% |
